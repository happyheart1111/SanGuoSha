  ...
  for (const f of factionOrder) {
    ...
    for (const hero of list) {
      const avatarColors = {
        ...
        'huangzhong': 'linear-gradient(135deg, #302010, #806030)',
        'machao': 'linear-gradient(135deg, #2a1a20, #804040)',
        'xiahoudun': 'linear-gradient(135deg, #2a1530, #603090)',
        'caoren': 'linear-gradient(135deg, #1a1a2a, #4050a0)',
        'simayi': 'linear-gradient(135deg, #2a2030, #5040a0)',
        'jiexusheng': 'linear-gradient(135deg, #0a2a1a, #206050)',
        'mouhuangzhong': 'linear-gradient(135deg, #2a1a0a, #7a5a20)',
      };
